...
public class NintendoCatalogPageServlet extends HttpServlet {
  ...
  protected void showPage(HttpServletResponse response, String message)
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
					...
					File inFile = new File(sc.getRealPath("Nintendoproduct.txt"));
				...
				return;
					...
					BufferedReader br = new BufferedReader(new FileReader(sc.getRealPath("Nintendoproduct.txt")));
				...
				while ((line = br.readLine()) != null) {
					...
					out.println("<input type='hidden' name='manufacturerName' value='Nintendo'>");
