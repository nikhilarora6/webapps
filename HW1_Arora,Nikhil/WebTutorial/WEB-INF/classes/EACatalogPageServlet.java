...
public class EACatalogPageServlet extends HttpServlet {
  ...
  protected void showPage(HttpServletResponse response, String message)
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
					...
					File inFile = new File(sc.getRealPath("EAproducts.txt"));
				...
				return;
					...
					BufferedReader br = new BufferedReader(new FileReader(sc.getRealPath("EAproducts.txt")));
					...
					out.println("<input type='hidden' name='manufacturerName' value='ElectronicArts'>");
