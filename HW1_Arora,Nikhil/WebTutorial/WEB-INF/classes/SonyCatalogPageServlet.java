...
public class SonyCatalogPageServlet extends HttpServlet {
  ...
  protected void showPage(HttpServletResponse response, String message)
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
					...
					File inFile = new File(sc.getRealPath("Sonyproduct.txt"));
				...
				return;
					...
					BufferedReader br = new BufferedReader(new FileReader(sc.getRealPath("Sonyproduct.txt")));
					String line = null;
					...
					out.println("<input type='hidden' name='manufacturerName' value='Sony'>");
