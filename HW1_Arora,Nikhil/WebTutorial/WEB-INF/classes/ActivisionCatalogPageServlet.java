...
public class ActivisionCatalogPageServlet extends HttpServlet {
  ...
  protected void showPage(HttpServletResponse response, String message)
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
					...
					File inFile = new File(sc.getRealPath("Activisionproduct.txt"));
					...
					BufferedReader br = new BufferedReader(new FileReader(sc.getRealPath("Activisionproduct.txt")));
				...
				while ((line = br.readLine()) != null) {
					...
					out.println("<input type='hidden' name='manufacturerName' value='Activision'>");
					out.println("<input type='hidden' name='productName' value="+name+">");
					out.println("<input type='hidden' name='productCategory' value='GameMaker'>");
					out.println("<input type='hidden' name='price' value="+price+">");
